...
const Work = ({isDarkMode}) => {
  return (
    ...
    id ='work' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        font-Ovo">My portfolio</motion.h4>
        <motion.h2 
        initial={{opacity: 0, y: -20}}
        whileInView={{opacity: 1 ,y: 0 }}
        ...
        className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
            ...
            showcases my skills in React, DevOps, and Agile software development.</motion.p>
    <motion.div 
    initial={{opacity: 0}}
    whileInView={{opacity: 1}}
    ...
    target="_blank" href="https://github.com/Sameera-05" className="w-max flex items-center justify-center gap-2 text-gray-700 
