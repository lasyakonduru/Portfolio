...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "ea807a08-8739-4ec8-9115-47388cddb8b0");
  ...
  return (
    ...
    bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
        ...
        font-Ovo">Connect with me</motion.h4>
        <motion.h2 
        initial={{opacity: 0, y: -20}}
        whileInView={{opacity: 1 ,y: 0 }}
        ...
        Have a job opportunity to share or just want to connect? I'm always open to new roles, 
        collaborations, or meaningful conversations. Fill out the form below — I'd love to hear from you!
        </motion.p>
        ...
        onSubmit={onSubmit} className="max-w-2xl mx-auto">
            ...
            {/* LinkedIn input takes full width below the two above */}
            <div className="mb-8">
                <motion.input 
                initial={{opacity: 0, y: 100}}
                whileInView={{opacity: 1 ,y: 0 }}
                transition={{duration:0.6,delay: 1.1 }}
                type="url" placeholder="Enter your LinkedIn profile link" required
                  className="w-full p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white dark:bg-darkHover/30 dark:border-white/90"  name="linkedin"/>
            </div>
            <motion.textarea
            initial={{opacity: 0, y: 100}}
            whileInView={{opacity: 1 ,y: 0 }}
