  ...
  return (
    <>
        <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden'> 
            <Image src={assets.header_bg_color} alt='' className='w-full placeholder="empty"'/>

        </div>
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%]
        py-0.5 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : "" }`}> 
            <a href="#top">
                <Image src={assets.logo} alt="Sameera Sineen Logo"
                className="w-44 h-auto cursor-pointer mr-4"/>
            ...
            px-12 py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50 dark:border dark:border-white/50 dark:bg-transparent"} `}>
                ...
                <li><a className= "font-Ovo" href="#contact">Hire Me</a></li>
            </ul>
            ...
            <div className='flex items-center gap-4'>
                ...
                gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo dark:border-white/50'>Contact 
            ...
            -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-darkHover dark-text-white'>
                ...
                <li><a className= "font-Ovo" onClick={closeMenu} href="#contact">Hire Me</a></li>
            </ul>
